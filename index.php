			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="login100-form validate-form">
					...
					if( isset($_POST['uname']) and isset($_POST['pwd']) ) {
							...
							$ret=mysqli_query( $conn, "SELECT * FROM users1 WHERE name='$user' AND pswd='$pass' ") or die("Could not execute query: " .mysqli_error($conn));
							$row = mysqli_fetch_assoc($ret);
							if(!$row) {		header("Location: login-error.php#");			}
							else {
								session_start();

								$_SESSION["go-uname"] = $user;
								// print_r($_SESSION);

								header('location: scan-me.php');
							}
					}
					////////////////////////////////////////////////////////////////////////////
					//////////////////////////////////////////////////////////////////////////////////
					...
					<div class="flex-c-m">
						<a href="signup.php" class="login100-social-item bg1">
