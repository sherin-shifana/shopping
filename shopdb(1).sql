...
--
-- Host: localhost:3306
-- Generation Time: May 02, 2019 at 11:58 AM
...
INSERT INTO `items` (`user`, `item`, `quantity`, `price`) VALUES
('abhi', 'apple', '2 Kg', 45),
('abhi', 'apple', '2 Kg', 45),
('abhi', 'pepsi', '2', 30),
('abhi', 'pepsi', '2', 30),
('sherin', 'mango', '1 Kg', 50),
('sherin', 'mango', '1 Kg', 50),
('abhi', 'potato', '1 Kg', 50),
('abhi', 'notebook', '5', 50);
...
(332, 'pranthan', 'patti', 'karanthur', 100, 'patti@gmail.com'),
(332, 'abhi', '123', 'att', 500, 'a@g.com'),
(332, 'sajan', 'kavitha', 'kk', 1000, 'sk@gmail.com'),
(111, 'sherin', '1234', 'lulu', 220, 'abc@gmail.com'),
(111, 'sherin', '123', 'lulu', 220, 'a@gmail.com'),
(111, 'sherin', '123', 'lulu', 220, 'a@gmail.com');
...
--
ALTER TABLE `temp_qr`
  MODIFY `slno` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
